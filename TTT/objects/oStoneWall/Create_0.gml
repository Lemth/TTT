...
normalDepthTexture = sprite_get_texture(sStoneWallNormalDepth, 0);
specGlossMap = sprite_get_texture(sStoneWallSpecGloss, 0);
aoMap = sprite_get_texture(sStoneWallAO, 0);
